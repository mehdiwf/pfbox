...
* orga code building
** todos
*** TODO understand why it is unstable
**** TOCHECK the grad x/y in samy is not in the same direction as mine
...
- div press
  ok
**** TODO conservation eq verification
***** DONE momentum
